...
## **This repo is deprecated and updated snippets can now be found in [the `vonage-python-code-snippets` repo](https://github.com/Vonage/vonage-python-code-snippets).**
